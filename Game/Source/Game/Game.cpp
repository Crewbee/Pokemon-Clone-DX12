...
void Game::LoadContent()
{
	...
	m_pDebugShader = new ShaderProgram("Data/Shaders/Color.vert", "Data/Shaders/Color.frag");
	...
	//Create our Textures
	m_Tileset = LoadTexture("Data/Textures/TileSet.png");
	m_OakLabTileset = LoadTexture("Data/Textures/OakLabTileSet.png");
	m_Sprites = LoadTexture("Data/Textures/Player_NPCSprites.png");
	m_WoodsTileset = LoadTexture("Data/Textures/WoodsTileSet.png");
	m_ExtrasSet = LoadTexture("Data/Textures/ExtrasTileSet.png");
	m_BattleScene = LoadTexture("Data/Textures/BattleScene.png");
	...
	m_MyResourceManager->UnpackJson("Data/Textures/TileSet.json", m_PalletTileMap);
	m_MyResourceManager->UnpackJson("Data/Textures/OakLabTileSet.json", m_OakLabTileMap);
	m_MyResourceManager->UnpackJson("Data/Textures/Player_NPCSprites.json", m_PalletTileMap);
	m_MyResourceManager->UnpackJson("Data/Textures/WoodsTileSet.json", m_WoodsTileMap);
	m_MyResourceManager->UnpackJson("Data/Textures/ExtrasTileSet.json", m_ExtrasTileMap);
	m_MyResourceManager->UnpackJson("Data/Textures/BattleScene.json", m_ExtrasTileMap);
