...
//Definition for single frame off a givven spritesheet
struct Frame {
	Frame(vec2 origin, vec2 size)
	{
		this->origin = origin;
		this->size = size;
	}
	...
	vec2 origin;
	vec2 size;
	vec2 worldSpace = vec2(0.0f, 0.0f);
	vec2 uvscale = vec2(0.0f, 0.0f);
...
struct TileInfo {
	...
	{
		this->MyLabType = aType;
	}
	TileInfo(Forest_Tile_Type aType)
	{
		this->MyForestType = aType;
	}
	TileInfo() {}
	Tile_Type MyType;
...
const float PLAYER_SPEED = 4.4f;
const float NPC_SPEED = 3.6f;

const unsigned int WORLDWIDTH = 50;
const unsigned int WORLDHEIGHT = 50;
...
const int NUM_TILETYPES = 13;
const int NUM_TILEVARIANTS = 34;

const int NUM_ROWS = 33;
const int NUM_COLUMNS = 32;

const int MAPSIZE = 1056;

const int NUM_LAB_ROWS = 15;
const int NUM_LAB_COLUMNS = 16;

const int LABSIZE = 240;

const int OAKMAXPATHSIZE = 20;
const int MAXPATHSIZE_TOWN_NPC = 50;

const int FORESTMAPSIZE = 2112;

const int NUM_FOREST_ROWS = 44;
const int NUM_FOREST_COLUMNS = 48;


//Definition of short BitMaps for each Area are defined here

const unsigned short PalletTownBitMap[MAPSIZE] = {	58,  74,  58,  74,  58,  74,  58,  74,  23,  84,  73,  89,  89,  105,  39,  39,  39,  39,  39,  39,  39,  39,  58,  74,  58,  74,  58,  74,  58,  74,  58,  74,
...
const unsigned short OakLabBitMap[LABSIZE] = {	9, 9,   9,   9,   9,   9,   9,   10,  10,  9,   9,   9,   9,   9,   9,   9,
...
const unsigned short ForestBitMap[FORESTMAPSIZE] = {	6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  7,  7,  6,  6,  6,  6,  6,  6,  6,  6,  6,  6,  
...
//	cJSON_AddNumberToObject(gameobject, "y", 2.5f);
...
//	cJSON* gameobjectLoad = cJSON_GetObjectItem(root, "gameobject");

//	float X = cJSON_GetObjectItem(gameobjectLoad, "x")->valuedouble;
//	float Y = cJSON_GetObjectItem(gameobjectLoad, "y")->valuedouble;
